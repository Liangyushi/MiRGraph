...
if __name__ == '__main__':
    ...
    for epoch in range(1, 1001):
        ...
        if val_aupr > best_val_aupr:
            ...
            torch.save(model, './HGT/HGTbest_cpu_ReduceLR_usingmiRNAanchor.pt')
    ...
    with open('./HGT/HGTResult_cpu_ReduceLR_usingmiRNAanchor.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
        pickle.dump([trainloss, trainauc,trainaupr,valloss,valauc,valaupr,lrchange], f)

    torch.save(model, './HGT/HGT_cpu_ReduceLR_usingmiRNAanchor.pt')