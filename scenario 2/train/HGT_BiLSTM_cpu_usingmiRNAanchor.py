...
if __name__ == '__main__':
    ...
    for epoch in range(1, 1001):
        ...
        if val_aupr > best_val_aupr:
            ...
            torch.save(model, './HGT_BiLSTM/HGT_BiLSTMbest_cpu_mlp_usingmiRNAanchor.pt')
            time_elapsed = time.time() - since
    ...
    with open('./HGT_BiLSTM/HGT_BiLSTMResult_cpu_mlp_usingmiRNAanchor.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
        pickle.dump([trainloss, trainauc,trainaupr,valloss,valauc,valaupr,lrchange], f)

    torch.save(model, './HGT_BiLSTM/HGT_BiLSTM_cpu_mlp_usingmiRNAanchor.pt')