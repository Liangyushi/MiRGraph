...
if __name__ == '__main__':
    ...
    with open('dataSplit_negall_usingmiRNAanchor.pkl','rb') as f:  # Python 3: open(..., 'rb')
        Xm,Xg,nodeM,nodeG,trainId,trainLabel,testId,testLabel,valId,valLabel,ppi,m,g = pickle.load(f)
    ...
    for epoch in range(1, 1001):
        ...
        if val_aupr > best_val_aupr:
            ...
            torch.save(model, './TransCNN/seqCNNbest_2_usingmiRNAanchor.pt')
    ...
    with open('./TransCNN/seqCNNResult_2_usingmiRNAanchor.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
        pickle.dump([trainloss, trainauc,trainaupr,valloss,valauc,valaupr,lrchange], f)

    torch.save(model, './TransCNN/seqCNN_2_usingmiRNAanchor.pt')